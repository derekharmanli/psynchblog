  ...
  return (
    <div className="modal-backdrop">
      <div className="modal">
        ...
        <p>
          - This is NOT medical advice. As this is AI generated content, there
          may be incorrect information.
        </p>
        <p>
          - The Key Points section is intended to be a 1-minute reading summary.
        </p>
        <p>
          - The Summary Section is intended to be a 5minute reading summary.
        </p>
        <p>
          - The Transcript will likely have the most errors and is AI&apos;s
          best attempt to transcribe the media.
        </p>
    ...
    <>
      ...
      <div className="bg-white embossed rounded-lg lg:p-8 pb-12 mb-8">
        ...
        <div className="px-4 lg:px-0">
          ...
          <h1 className="text-3xl mb-1 font-semibold text-shadow">
            {post.title}
          </h1>
          <h3 className="border-b-4 mb-4 font-semibold text-xs">
            {"from "}{" "}
            <img
          ...
          <div className="flex flex-row">
            <h2
              className="text-xl border bg-pink-600 p-2 rounded-full text-white text-center font-semibold border-b mb-2"
              style={{ width: "100%" }}
            >
              Media
            </h2>
          ...
          {showMedia && (
            <div>
              <h3 className="mb-2 font-semibold text-s">
                <img
                  alt={post.categories[0].name}
                  height="20px"
                  width="20px"
              ...
              <span className="underline">{"Published Date"}</span>
              <span>{": "}</span>
              <span>{moment(post.dateOfPodcast).format("MMM DD, YYYY")}</span>
              <div className="mt-3">
                <ReactAudioPlayer src={post.podcast.url} controls />
              </div>
            </div>
          )}
          <div className="flex flex-row">
          ...
          {showLinks && (
            <div
              className={`${
                post.importantLinks && post.importantLinks.html
                  ? "underline text-blue-600 hover:text-blue-800 visited:text-purple-600"
                  : "text-black"
              }`}
            >
              {post.importantLinks && post.importantLinks.html
                ? parse(post.importantLinks.html)
