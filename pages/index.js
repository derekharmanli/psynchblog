  ...
  return (
    <div className={` ${isSmallScreen ? 'landing-container-small' : 'landing-container'}`}>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-pink-900 text-white text-center py-2">
        <span>&#169; Psynch 2023. {`${isSmallScreen ? '' : 'All Rights Reserved'}`} Courtesy of <a href="https://www.linkedin.com/in/derekharmanli" target="_blank" rel="noopener noreferrer">Derek Harmanli</a></span>
      </div>
    </div>
  );
}
